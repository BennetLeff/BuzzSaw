...
public:
    // Default constructor
    LowShelfFilter() :LowShelfFilter(48e3, 0.1778, 500) { };

    // Destructor
    ~LowShelfFilter() { };

    // Constructor with sampling frequency
    LowShelfFilter(T samplingFrequency) :
        LowShelfFilter(samplingFrequency, 0.1778, 500) { };

    // Constructor for all parameters
    LowShelfFilter(T samplingFrequency, T stopBandGain, T cutoffFrequency) :
